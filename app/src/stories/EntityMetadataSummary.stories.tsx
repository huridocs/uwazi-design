 ...
 *  own titled MetadataCard, in template order, then the relationship/inherited
 *  cards — one card system the whole way down, at every width. Reads the same
 *  entity profile the main Metadata view uses. */
const meta = {
