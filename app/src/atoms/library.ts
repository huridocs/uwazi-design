 ...
 *  sits inside it. */
/** How tall the card's preview band is drawn. A Display-menu control again on
 *  `main` (2026-09-23); the FRAME and FIT controls stay on `playground`, and the
 *  card keeps landscape / auto. Small is a 60px band, the default here: the
 *  page identifies the entity, the text below it does the work. */
